...
var $author$project$Components$photo = F4(
	function (view, p, headlineClick, fullscreenClick) {
		var viewPhoto = _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(p.text)
							]))
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$src(p.image)
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$class('headline')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(p.headline)
							]))
					]))
			]);
		if (view.$ === 'Article') {
			return A2(
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Html$Styled$Attributes$class('article')
					]),
				_Utils_ap(
					viewPhoto,
					_List_fromArray(

...
var $author$project$Components$blue = A3($rtfeldman$elm_css$Css$rgb, 38, 58, 114);
		...
		[
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Css$backgroundColor($author$project$Components$blue),
...
var $author$project$Components$almostWhite = $rtfeldman$elm_css$Css$hex('#d6d6d6');
		...
		[
			...
			_List_fromArray(
				[
					...
					$author$project$Components$almostWhite)
				]))
		]),
	_List_Nil);
...
var $author$project$Components$square = function (size) {
				...
				[
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Css$color($author$project$Components$white),
					...
					$rtfeldman$elm_css$Html$Styled$Events$onClick(onToggleClick)
				]),
			_List_fromArray(
				[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_Nil),
					A2(
					$author$project$Components$toggleFullscreen,
					fullscreenClick,
...
var $author$project$Components$defaultH = function (fs) {
	return $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Components$defaultH(
									$rtfeldman$elm_css$Css$em(2)),
...
var $author$project$Components$fadeIn = $rtfeldman$elm_css$Css$Animations$keyframes(
	_List_fromArray(
		[
			_Utils_Tuple2(
			0,
...
var $author$project$Components$fadeOut = $rtfeldman$elm_css$Css$Animations$keyframes(
	_List_fromArray(
		[
			_Utils_Tuple2(
			0,
...
var $author$project$Components$photoHeadline = F4(
	function (headline, bottomPercent, delay, headlineClick) {
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A3($rtfeldman$elm_css$Css$Transitions$bottom3, 500, delay, $rtfeldman$elm_css$Css$Transitions$ease)
								])),
							$rtfeldman$elm_css$Css$hover(
							_List_fromArray(
								[
		...
		return A2(
					...
					_Utils_ap(
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$backgroundColor($author$project$Components$black),
							...
							if (view.$ === 'Article') {
								return _List_fromArray(
									[
										...
										_List_fromArray(
											[
												A3($rtfeldman$elm_css$Css$Transitions$height3, 500, 0, $rtfeldman$elm_css$Css$Transitions$ease)
											]))
									]);
							} else {
								return _List_fromArray(
									[
										...
										_List_fromArray(
											[
												A3($rtfeldman$elm_css$Css$Transitions$height3, 500, 500, $rtfeldman$elm_css$Css$Transitions$ease)
											]))
									]);
							}
						}()))
			...
			_List_fromArray(
				[
								...
								return $rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													A3($rtfeldman$elm_css$Css$Transitions$opacity3, 500, 500, $rtfeldman$elm_css$Css$Transitions$ease),
													A3($rtfeldman$elm_css$Css$Transitions$width3, 500, 0, $rtfeldman$elm_css$Css$Transitions$ease)
												]))
										]));
							} else {
								return $rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													A3($rtfeldman$elm_css$Css$Transitions$opacity3, 500, 0, $rtfeldman$elm_css$Css$Transitions$ease),
													A3($rtfeldman$elm_css$Css$Transitions$width3, 500, 500, $rtfeldman$elm_css$Css$Transitions$ease),
													A3($rtfeldman$elm_css$Css$Transitions$height3, 500, 500, $rtfeldman$elm_css$Css$Transitions$ease)
												]))
										]));
							}
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															A3($rtfeldman$elm_css$Css$Transitions$border3, 500, 0, $rtfeldman$elm_css$Css$Transitions$ease),
															A3($rtfeldman$elm_css$Css$Transitions$filter3, 500, 0, $rtfeldman$elm_css$Css$Transitions$ease),
															A3($rtfeldman$elm_css$Css$Transitions$margin3, 500, 0, $rtfeldman$elm_css$Css$Transitions$ease),
															A3($rtfeldman$elm_css$Css$Transitions$width3, 500, 0, $rtfeldman$elm_css$Css$Transitions$ease)
														]))
												])),
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															A3($rtfeldman$elm_css$Css$Transitions$border3, 500, 500, $rtfeldman$elm_css$Css$Transitions$ease),
															A3($rtfeldman$elm_css$Css$Transitions$filter3, 500, 500, $rtfeldman$elm_css$Css$Transitions$ease),
															A3($rtfeldman$elm_css$Css$Transitions$margin3, 500, 500, $rtfeldman$elm_css$Css$Transitions$ease),
															A3($rtfeldman$elm_css$Css$Transitions$width3, 500, 500, $rtfeldman$elm_css$Css$Transitions$ease)
														]))
												])),
											$rtfeldman$elm_css$Html$Styled$Attributes$src(image)
					...
					function () {
					if (view.$ === 'Article') {
						return A4($author$project$Components$photoHeadline, headline, 8, 0, headlineClick);
					} else {
						return A4($author$project$Components$photoHeadline, headline, 0, 500, headlineClick);
					}
				}(),
					function () {
					if (view.$ === 'Article') {
						var animation = $rtfeldman$elm_css$Css$batch(
							_List_fromArray(
								[
									$rtfeldman$elm_css$Css$opacity($rtfeldman$elm_css$Css$zero),
									$rtfeldman$elm_css$Css$animationName($author$project$Components$fadeIn),
						...
						var animation = $rtfeldman$elm_css$Css$batch(
							_List_fromArray(
								[
									$rtfeldman$elm_css$Css$opacity(
									$rtfeldman$elm_css$Css$num(100)),
									$rtfeldman$elm_css$Css$animationName($author$project$Components$fadeOut),
									$rtfeldman$elm_css$Css$animationDuration(
									$rtfeldman$elm_css$Css$sec(0.5)),
									$rtfeldman$elm_css$Css$animationDelay(
									$rtfeldman$elm_css$Css$sec(0)),
									A2($rtfeldman$elm_css$Css$property, 'animation-fill-mode', 'forwards')
								]));
						return A2(
							$author$project$Components$toggleFullscreen,
